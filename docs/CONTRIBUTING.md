...
[create a proposal](https://github.com/zfcampus/zf-development-mode/issues/new).
...
2. Fork the repository (https://github.com/zfcampus/zf-development-mode)
...
4. Add a remote to your fork; substitute your GitHub username in the command
   ...
   ```console
   $ git remote add {username} git@github.com:{username}/zf-development-mode.git
   $ git fetch {username}
   ```
...
To ssh://git@github.com/{username}/zf-development-mode.git
